...
const Catalog = () => {
  ...
  //Exemplo de uso de função async no useEffect:
  //O useEffect não aceita funções async, não é asincrono. Se precisar rodar função async, criar fora conforme abaixo, e depois chamar normal o "executor();" dentro do useEffect:
    // const executor = async () => {
    //   const products = await getProducts();//aguarda tudo esta função rodar por completo para depois chamar a linha abaixo
    //   getProductDependency(products);
    // }
    ...
    >
      {
        ...
        return (
          <Grid item xs={12} sm={6} md={4} lg={3} className="catalog-item">
            ...
            <img src={products[id].images[0]} /> //Se 
